...
export default function Colour() {
  const {
    ...
    isViewing,
    isEditMode
  } = useMasterNavigation("colourdetails", { colourCode: "CL001", colourName: "" });
    ...
    if (currentIndex === -1) {
      ...
      if (items && items.length > 0) {
        const maxCodeNum = items.reduce((max, item) => {
          ...
          if (codeToCheck && codeToCheck.startsWith("CL")) {
        ...
        nextCode = "CL" + nextNum.toString().padStart(3, "0");
      }
  ...
  return (
    <div className="master-container">
      <div className="master-header">
        <h2>
          <FaPaintBrush /> Colour Management
        </h2>
